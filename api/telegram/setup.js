...
module.exports = async function handler(req, res){
  ...
  try{
    ...
    const privateCommands = [
      ...
      { command:"missions", description:"Mission quick guide" },
      { command:"leaderboard", description:"Open leaderboard menu" },
      { command:"rank", description:"Show your rank" },
      { command:"top10", description:"Show global top 10" },
      ...
      { command:"server", description:"Bot/server status" },
      { command:"season", description:"Current season info" },
      { command:"tips", description:"Quick gameplay tips" },
      ...
      { command:"daily", description:"Daily reward info" },
      { command:"rewards", description:"Rewards and daily info" },
      { command:"reportbug", description:"Report a bug" },
      { command:"feedback", description:"Send gameplay feedback" },
      { command:"contact", description:"Support contact options" },
