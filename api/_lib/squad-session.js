...
const SHARED_STORY_MISSIONS = Object.freeze({
  ...
  71:Object.freeze({
    level:71, chapter:8, chapterName:"The Tiger King", title:"Story Mission 71",
    objective:"Escort eight villagers fleeing the jungle center through three evacuation checkpoints, clear the pursuing tigers, and extract together.", rescueRequired:8,
    dangerNote:"The fleeing villagers move only after both soldiers secure each evacuation checkpoint.", aggressionLabel:"Jungle Center Evacuation", hazardDamageBonus:5,
    timeLimitMs:17 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    checkpoints:Object.freeze([
      Object.freeze({ id:"s71_center_gate", x:320, y:405, r:125, label:"Jungle Center Gate" }),
      Object.freeze({ id:"s71_forest_lane", x:620, y:520, r:125, label:"Forest Evacuation Lane" }),
      Object.freeze({ id:"s71_outer_shelter", x:910, y:685, r:130, label:"Outer Jungle Shelter" }),
    ]),
    civilians:Object.freeze([
      Object.freeze({ id:"s71_elder", x:205, y:245, name:"Jungle Center Elder", look:"field", vip:true }),
      Object.freeze({ id:"s71_parent_1", x:310, y:390, name:"Fleeing Parent", look:"medic" }),
      Object.freeze({ id:"s71_guardian", x:420, y:255, name:"Village Guardian", look:"scout" }),
      Object.freeze({ id:"s71_worker", x:535, y:465, name:"Village Worker", look:"driver" }),
      Object.freeze({ id:"s71_healer", x:650, y:290, name:"Jungle Healer", look:"medic" }),
      Object.freeze({ id:"s71_parent_2", x:760, y:515, name:"Fleeing Caregiver", look:"field" }),
      Object.freeze({ id:"s71_scout", x:865, y:325, name:"Evacuation Scout", look:"scout" }),
      Object.freeze({ id:"s71_survivor", x:930, y:675, name:"Jungle Survivor", look:"driver" }),
    ]),
    tigers:chapter7TigerPack("s71_pursuer", "Center Pursuer", 8, { hpBase:490, speed:.93 }),
  }),
  72:Object.freeze({
    level:72, chapter:8, chapterName:"The Tiger King", title:"Story Mission 72",
    objective:"Rescue five surrounded civilians, clear the six-tiger all-directions ambush, and extract together.", rescueRequired:5,
    dangerNote:"This is the corrected focused ambush: every survivor and tiger is marked, with no hidden objective elsewhere on the map.", aggressionLabel:"All-Directions Rescue Ambush", hazardDamageBonus:6, hazardCooldownMs:735,
    timeLimitMs:16 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    civilians:Object.freeze([
      Object.freeze({ id:"s72_center_medic", x:520, y:415, name:"Surrounded Medic", look:"medic", vip:true }),
      Object.freeze({ id:"s72_center_scout", x:625, y:510, name:"Surrounded Scout", look:"scout" }),
      Object.freeze({ id:"s72_center_worker", x:730, y:415, name:"Surrounded Worker", look:"driver" }),
      Object.freeze({ id:"s72_center_parent", x:525, y:615, name:"Surrounded Parent", look:"field" }),
      Object.freeze({ id:"s72_center_guide", x:730, y:615, name:"Surrounded Guide", look:"scout" }),
    ]),
    tigers:chapter7TigerPack("s72_ambush", "Ambush Tiger", 6, { hpBase:510, speed:.98, types:["Scout","Stalker","Stalker","Standard","Armored","Standard"] }),
  }),
  73:Object.freeze({
    level:73, chapter:8, chapterName:"The Tiger King", title:"Story Mission 73",
    objective:"Capture both elite hunter tigers alive with Rubber ammunition, clear their three guards, and extract together.", rescueRequired:0, captureRequired:2,
    captureTargetIds:Object.freeze(["s73_razorclaw","s73_shadowfang"]),
    dangerNote:"Razorclaw and Shadowfang must remain alive. One Real-ammo hit permanently disqualifies that tiger from capture.", aggressionLabel:"Elite Hunter Capture", hazardDamageBonus:5,
    timeLimitMs:17 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS, civilians:Object.freeze([]),
    tigers:Object.freeze([
      Object.freeze({ id:"s73_razorclaw", name:"Razorclaw Elite Hunter", type:"Stalker", hpMax:900, baseX:350, baseY:390, rangeX:205, rangeY:150, speed:1.00, phase:.7 }),
      Object.freeze({ id:"s73_shadowfang", name:"Shadowfang Elite Hunter", type:"Stalker", hpMax:940, baseX:825, baseY:615, rangeX:215, rangeY:155, speed:1.02, phase:2.5 }),
      Object.freeze({ id:"s73_guard_1", name:"Hunter Guard One", type:"Scout", hpMax:570, baseX:540, baseY:285, rangeX:165, rangeY:125, speed:1.02, phase:3.4 }),
      Object.freeze({ id:"s73_guard_2", name:"Hunter Guard Two", type:"Standard", hpMax:690, baseX:650, baseY:520, rangeX:170, rangeY:130, speed:.91, phase:4.6 }),
      Object.freeze({ id:"s73_guard_3", name:"Hunter Guard Three", type:"Armored", hpMax:870, baseX:940, baseY:345, rangeX:150, rangeY:120, speed:.76, phase:5.8 }),
    ]),
  }),
  74:Object.freeze({
    level:74, chapter:8, chapterName:"The Tiger King", title:"Story Mission 74",
    objective:"Escort the eight-person caravan through three dangerous jungle checkpoints, clear the route, and extract together.", rescueRequired:8,
    dangerNote:"The caravan advances only when both soldiers secure each checkpoint. Tigers attack from both sides of the road.", aggressionLabel:"Dangerous Jungle Caravan", hazardDamageBonus:5,
    timeLimitMs:18 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    checkpoints:Object.freeze([
      Object.freeze({ id:"s74_caravan_departure", x:310, y:405, r:130, label:"Caravan Departure" }),
      Object.freeze({ id:"s74_danger_pass", x:620, y:520, r:130, label:"Danger Jungle Pass" }),
      Object.freeze({ id:"s74_safe_outpost", x:915, y:685, r:135, label:"Caravan Safe Outpost" }),
    ]),
    civilians:Object.freeze([
      Object.freeze({ id:"s74_driver", x:215, y:250, name:"Lead Caravan Driver", look:"driver", vip:true }),
      Object.freeze({ id:"s74_guard", x:325, y:390, name:"Caravan Guard", look:"scout" }),
      Object.freeze({ id:"s74_medic", x:435, y:260, name:"Caravan Medic", look:"medic" }),
      Object.freeze({ id:"s74_trader", x:545, y:470, name:"Caravan Trader", look:"field" }),
      Object.freeze({ id:"s74_engineer", x:655, y:300, name:"Vehicle Engineer", look:"driver" }),
      Object.freeze({ id:"s74_guide", x:765, y:520, name:"Jungle Route Guide", look:"scout" }),
      Object.freeze({ id:"s74_supply", x:870, y:330, name:"Supply Keeper", look:"field" }),
      Object.freeze({ id:"s74_rear_guard", x:930, y:675, name:"Rear Caravan Guard", look:"scout" }),
    ]),
    tigers:chapter7TigerPack("s74_caravan", "Caravan Route Tiger", 10, { hpBase:500, speed:.94 }),
  }),
  75:Object.freeze({
    level:75, chapter:8, chapterName:"The Tiger King", title:"Story Mission 75",
    objective:"Survive and clear the fifteen-tiger swarm attacking from the Tiger King's territory.", rescueRequired:0,
    dangerNote:"Fifteen coordinated tigers attack in a fast cycle. Stay together and control the pack before moving to extraction.", aggressionLabel:"Tiger King Swarm", hazardDamageBonus:8, hazardCooldownMs:660,
    timeLimitMs:19 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS, civilians:Object.freeze([]),
    tigers:chapter7TigerPack("s75_swarm", "Tiger King Swarm", 15, { hpBase:500, speed:.98 }),
  }),
  76:Object.freeze({
    level:76, chapter:8, chapterName:"The Tiger King", title:"Story Mission 76",
    objective:"Find and rescue six lost soldiers, guide them through three rally points, clear the hunters, and extract together.", rescueRequired:6,
    dangerNote:"The lost patrol is scattered. Either player may rescue an unclaimed soldier, but both teammates must secure each rally point.", aggressionLabel:"Lost Soldier Rescue", hazardDamageBonus:6,
    timeLimitMs:18 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    checkpoints:Object.freeze([
      Object.freeze({ id:"s76_patrol_signal", x:325, y:405, r:125, label:"Lost Patrol Signal" }),
      Object.freeze({ id:"s76_field_rally", x:620, y:520, r:125, label:"Field Rally Point" }),
      Object.freeze({ id:"s76_rescue_lane", x:910, y:685, r:130, label:"Soldier Rescue Lane" }),
    ]),
    civilians:Object.freeze([
      Object.freeze({ id:"s76_captain", x:210, y:245, name:"Lost Patrol Captain", look:"soldier", vip:true }),
      Object.freeze({ id:"s76_medic", x:350, y:390, name:"Patrol Combat Medic", look:"soldier" }),
      Object.freeze({ id:"s76_rifleman", x:475, y:270, name:"Lost Rifleman", look:"soldier" }),
      Object.freeze({ id:"s76_engineer", x:610, y:475, name:"Patrol Engineer", look:"soldier" }),
      Object.freeze({ id:"s76_radio", x:760, y:305, name:"Radio Operator", look:"soldier" }),
      Object.freeze({ id:"s76_rearguard", x:925, y:675, name:"Lost Rear Guard", look:"soldier" }),
    ]),
    tigers:chapter7TigerPack("s76_hunter", "Patrol Hunter", 9, { hpBase:510, speed:.95 }),
  }),
  77:Object.freeze({
    level:77, chapter:8, chapterName:"The Tiger King", title:"Story Mission 77",
    objective:"Escort ten final villagers out of the jungle through three shared evacuation checkpoints and clear the pursuing pack.", rescueRequired:10,
    dangerNote:"This is the last village evacuation before the Tiger King assault. Both soldiers must finish inside extraction.", aggressionLabel:"Final Villager Evacuation", hazardDamageBonus:6,
    timeLimitMs:19 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    checkpoints:Object.freeze([
      Object.freeze({ id:"s77_village_gate", x:315, y:405, r:130, label:"Final Village Gate" }),
      Object.freeze({ id:"s77_jungle_exit", x:620, y:520, r:130, label:"Jungle Exit Route" }),
      Object.freeze({ id:"s77_evac_staging", x:915, y:685, r:135, label:"Final Evacuation Staging" }),
    ]),
    civilians:Object.freeze([
      Object.freeze({ id:"s77_elder", x:185, y:245, name:"Final Village Elder", look:"field", vip:true }),
      Object.freeze({ id:"s77_medic", x:275, y:385, name:"Village Medic", look:"medic" }),
      Object.freeze({ id:"s77_guide", x:365, y:260, name:"Jungle Guide", look:"scout" }),
      Object.freeze({ id:"s77_parent_1", x:455, y:455, name:"Village Parent One", look:"field" }),
      Object.freeze({ id:"s77_worker_1", x:545, y:285, name:"Village Worker One", look:"driver" }),
      Object.freeze({ id:"s77_parent_2", x:635, y:505, name:"Village Parent Two", look:"medic" }),
      Object.freeze({ id:"s77_scout", x:725, y:300, name:"Village Scout", look:"scout" }),
      Object.freeze({ id:"s77_worker_2", x:805, y:540, name:"Village Worker Two", look:"driver" }),
      Object.freeze({ id:"s77_farmer", x:880, y:345, name:"Jungle Farmer", look:"field" }),
      Object.freeze({ id:"s77_survivor", x:935, y:675, name:"Final Survivor", look:"medic" }),
    ]),
    tigers:chapter7TigerPack("s77_pursuer", "Evacuation Pursuer", 10, { hpBase:515, speed:.96 }),
  }),
  78:Object.freeze({
    level:78, chapter:8, chapterName:"The Tiger King", title:"Story Mission 78",
    objective:"Survive the massive sixteen-tiger jungle ambush, clear every threat, and extract together.", rescueRequired:0,
    dangerNote:"Sixteen tigers surround the squad. Lethal kills intensify the surviving pack through the blood-scent system.", aggressionLabel:"Massive Tiger King Ambush", hazardDamageBonus:9, aggressionPerKill:2, hazardCooldownMs:625,
    timeLimitMs:20 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS, civilians:Object.freeze([]),
    tigers:chapter7TigerPack("s78_massive_ambush", "King's Ambush Tiger", 16, { hpBase:520, speed:1.00 }),
  }),
  79:Object.freeze({
    level:79, chapter:8, chapterName:"The Tiger King", title:"Story Mission 79",
    objective:"Prepare for the Tiger King by activating four field stations, defeating his twelve-tiger vanguard, and extracting together.", rescueRequired:0,
    dangerNote:"Preparation is real gameplay: both soldiers must activate the armory, medical, signal, and tracking stations in order.", aggressionLabel:"Tiger King Preparation", hazardDamageBonus:7, hazardCooldownMs:675,
    timeLimitMs:19 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS,
    checkpoints:Object.freeze([
      Object.freeze({ id:"s79_armory", x:270, y:365, r:125, label:"Forward Armory" }),
      Object.freeze({ id:"s79_medical", x:500, y:285, r:125, label:"Field Medical Station" }),
      Object.freeze({ id:"s79_signal", x:730, y:525, r:125, label:"Signal Relay Station" }),
      Object.freeze({ id:"s79_tracking", x:930, y:690, r:130, label:"Tiger King Tracking Station" }),
    ]),
    civilians:Object.freeze([]),
    tigers:chapter7TigerPack("s79_vanguard", "Tiger King Vanguard", 12, { hpBase:535, speed:.99 }),
  }),
  80:Object.freeze({
    level:80, chapter:8, chapterName:"The Tiger King", title:"Story Mission 80",
    objective:"Defeat or capture the Tiger King, then reach extraction together to finish Chapter 8.", rescueRequired:0,
    dangerNote:"The Tiger King is the strongest threat so far and enters Royal Rage below 35% health.", aggressionLabel:"Tiger King Boss", hazardDamageBonus:10, hazardCooldownMs:620,
    timeLimitMs:20 * 60 * 1000, world:WORLD, extraction:EXTRACTION, spawns:SPAWNS, civilians:Object.freeze([]),
    tigers:Object.freeze([
...
const SHARED_STORY_WORLD_SIZES = Object.freeze({
  ...
  71:Object.freeze({ width:4800, height:2800 }),
  72:Object.freeze({ width:4800, height:2800 }),
  73:Object.freeze({ width:4800, height:2800 }),
  74:Object.freeze({ width:4800, height:2800 }),
  75:Object.freeze({ width:4800, height:2800 }),
  76:Object.freeze({ width:4800, height:2800 }),
  77:Object.freeze({ width:4800, height:2800 }),
...
const LIVING_WORLD_PATROL_DEFS = Object.freeze({
  ...
  amara_haven:Object.freeze([
    Object.freeze({ id:"living-amara-stalker-1", name:"Amara Road Stalker", type:"Stalker", hpMax:285, baseX:860, baseY:345, rangeX:164, rangeY:116, speed:.74, phase:1.7, boss:false }),
    Object.freeze({ id:"living-amara-stalker-2", name:"Haven Forest Prowler", type:"Stalker", hpMax:310, baseX:730, baseY:730, rangeX:158, rangeY:126, speed:.77, phase:3.6, boss:false }),
  ]),
});
...
function normalizeLivingWorldMission(raw){
  ...
  return {
    enabled:!!src.enabled && ["river_gate","jungle_spine","iron_roar","bloodroot_passage","amara_haven","crimson_hollow","veil_canopy"].includes(cleanText(src.districtId, 40)),
    ...
    damageBonus:clamp(Math.floor(Number(src.damageBonus || 0)), 0, 6),
    support:{
      ...
      fieldHospital:!!support.fieldHospital,
      rescueBeacons:!!support.rescueBeacons,
      caravanRoute:!!support.caravanRoute,
      childShelter:!!support.childShelter,
      conservationCamp:!!support.conservationCamp,
      calmingTowers:!!support.calmingTowers,
      swarmDefenses:!!support.swarmDefenses,
      bossWard:!!support.bossWard,
      bossRageReduction:clamp(Math.floor(Number(support.bossRageReduction || 0)), 0, 6),
      researchOutpost:!!support.researchOutpost,
      canopyBeacons:!!support.canopyBeacons,
      protectedResearchRoute:!!support.protectedResearchRoute,
      veilLab:!!support.veilLab,
      ...
      damageReduction:clamp(Math.floor(Number(support.damageReduction || 0)), 0, 2),
      civilianDamageMul:clamp(Number(support.civilianDamageMul ?? 1), .65, 1),
...
function activeLivingWorldMission(session){
  ...
  return session?.launchType === "shared-story" && level >= 1 && level <= 23 && consequence.enabled && consequence.missionLevel === level && consequence.districtId === district?.id
    ? consequence
...
async function createSession(user, opts={}){
  ...
  let session = await writeSession({
    ...
    livingWorldMission:launchType === "shared-story" && storyMissionLevel <= 23
...
function sessionDerived(session, players, at=nowMs()){
  ...
  const bloodRageDamage = bloodRageActive ? Math.max(0, 6 - Number(livingWorldEffect.support?.bossRageReduction || 0)) : 0;
...
async function buildSnapshot(session, viewerId){
  ...
  return {
    ...
    settlementSupport:livingWorldEffect.enabled && (livingWorldEffect.support?.safeHouse || livingWorldEffect.support?.rangerStation || livingWorldEffect.support?.armoryDepot || livingWorldEffect.support?.fieldClinic || livingWorldEffect.support?.researchPost || livingWorldEffect.support?.fieldHospital || livingWorldEffect.support?.conservationCamp || livingWorldEffect.support?.researchOutpost) ? {
      x:Math.round(Number(mission.world.width || 1200) * (livingWorldEffect.districtId === "veil_canopy" ? .36 : (livingWorldEffect.districtId === "crimson_hollow" ? .44 : (livingWorldEffect.districtId === "amara_haven" ? .72 : (livingWorldEffect.districtId === "bloodroot_passage" ? .31 : (livingWorldEffect.districtId === "iron_roar" ? .38 : (livingWorldEffect.districtId === "jungle_spine" ? .34 : .27))))))),
      y:Math.round(Number(mission.world.height || 1100) * (livingWorldEffect.districtId === "veil_canopy" ? .62 : (livingWorldEffect.districtId === "crimson_hollow" ? .66 : (livingWorldEffect.districtId === "amara_haven" ? .34 : (livingWorldEffect.districtId === "bloodroot_passage" ? .58 : (livingWorldEffect.districtId === "iron_roar" ? .64 : (livingWorldEffect.districtId === "jungle_spine" ? .48 : .69))))))),
      r:88,
      label:livingWorldEffect.districtId === "veil_canopy" ? (livingWorldEffect.support?.veilLab ? "Veil Canopy Field Lab" : "Veil Canopy Research Outpost") : (livingWorldEffect.districtId === "crimson_hollow" ? "Crimson Hollow Conservation Camp" : (livingWorldEffect.districtId === "amara_haven" ? "Amara Haven Field Hospital" : (livingWorldEffect.districtId === "bloodroot_passage" ? (livingWorldEffect.support?.researchPost ? "Bloodroot Research Clinic" : "Bloodroot Trail Clinic") : (livingWorldEffect.districtId === "iron_roar" ? "Iron Roar Armory Depot" : (livingWorldEffect.districtId === "jungle_spine" ? "Jungle Spine Ranger Station" : "River Gate Safe House"))))),
      type:livingWorldEffect.districtId === "veil_canopy" ? "veil_outpost" : (livingWorldEffect.districtId === "crimson_hollow" ? "crimson_camp" : (livingWorldEffect.districtId === "amara_haven" ? "amara_hospital" : (livingWorldEffect.districtId === "bloodroot_passage" ? "bloodroot_clinic" : (livingWorldEffect.districtId === "iron_roar" ? "iron_armory" : (livingWorldEffect.districtId === "jungle_spine" ? "jungle_ranger" : "river_safe_house"))))),
...
async function updateOwnPresence(session, user, patch={}){
  ...
  if(session.status === "active" && !player.downed){
    ...
    const bloodScentActive = nearestCarcassDistance <= 360 || persistentBloodScent > 0;
      ...
      const bloodRageDamage = bloodRage ? Math.max(0, 6 - Number(livingWorldEffect.support?.bossRageReduction || 0)) : 0;
    ...
    if(threat && distance(player, threat) <= huntRange && now - player.lastHazardAt >= hazardCooldown){
      ...
      const aggressionDamage = Math.max(0, Number(mission.hazardDamageBonus || 0))
        ...
        + bloodRageDamage
        + Math.max(0, Number(livingWorldEffect.damageBonus || 0));
      const districtDefense = Math.max(0, Number(livingWorldEffect.support?.damageReduction || 0));
      damagePlayer(player, Math.max(5, Math.round((baseDamage + aggressionDamage - roleArmor - districtDefense) * livingBalance.damageMul)));
      player.lastHazardAt = now;
      if(player.hp <= 0){
        player.downed = true;
        player.knockdowns = clamp(player.knockdowns + 1, 0, 999);
...
async function applyAction(session, user, action, payload={}){
  ...
  if(action === "start" || action === "restart" || action === "continue"){
    ...
    if(session.launchType === "shared-story" && Number(session.storyMissionLevel || 0) <= 23){
...
async function claimReward(session, user){
  ...
  const sharedRewards = {
    ...
    71:{ cash:71800, perkPoints:15, seasonPoints:169, badge:"Jungle Center Lifeline" },
    72:{ cash:74700, perkPoints:15, seasonPoints:173, badge:"All-Directions Responders" },
    73:{ cash:77800, perkPoints:15, seasonPoints:178, badge:"Elite Hunter Researchers" },
    74:{ cash:81000, perkPoints:16, seasonPoints:183, badge:"Dangerous Caravan Guard" },
    75:{ cash:84400, perkPoints:16, seasonPoints:188, badge:"Tiger King Swarm Survivors" },
    76:{ cash:87900, perkPoints:16, seasonPoints:194, badge:"Lost Patrol Rescue Team" },
    77:{ cash:91600, perkPoints:16, seasonPoints:200, badge:"Final Village Lifeline" },
