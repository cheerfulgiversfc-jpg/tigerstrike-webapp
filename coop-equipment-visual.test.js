...
test("V10.2 uses one cache key for every gameplay module", () => {
  assert(game.includes('const TS_BUILD = "5075"'));
  for(const file of ["game.js", "living-world.js", "squad-motion.js", "squad-coop.js", "field-systems.js", "ammo-modes.js", "tutorial.js"]){
    assert(html.includes(`${file}?v=5075-living-world`), `stale cache key for ${file}`);
  }
});
